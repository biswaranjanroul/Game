...
def main():
    ...
    pygame.display.set_caption('PRABHAT')
    showTextScreen('PRABHAT')
    while True:
        if random.randint(0, 1) == 0:
            pygame.mixer.music.load('C:/Users/91958/Downloads/music/Kaash - Arijit Singh.mp3')
        else:
            pygame.mixer.music.load('C:/Users/91958/Downloads/music/Teri Ban Jaungi Reprise - Acoustics.mp3')
